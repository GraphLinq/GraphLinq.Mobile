      ...
      <ScrollView flexDirection={"column"} p={["7","10"]} >
        ...
        {graphsList.length == 0 && loaded &&
          <View flexDirection='row' justifyContent='center' alignItems='center' bg='rgb(32,27,64)' borderRadius={'32'} p='3' my='1' maxW={'400'}>
            ...
            <Text color='white' fontSize={'sm'}>You have not created or deployed and Graphs yet, Refer to our <Link marginLeft="1" href="https://docs.graphlinq.io/graph" isExternal _text={{color:'amber.600'}}>documentation</Link> to start your journey.</Text>
          </View>
        }
        {graphsList.length > 0 &&
